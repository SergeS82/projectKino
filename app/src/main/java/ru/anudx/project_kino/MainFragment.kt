 ...
 */
class MainFragment(val mainContext: Context) : Fragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(mainContext: Context, param1: String, param2: String) =
            MainFragment(mainContext).apply {
    ...
    private fun initRecyclerView() {
        val adapter = CommonAdapter(mainContext)
